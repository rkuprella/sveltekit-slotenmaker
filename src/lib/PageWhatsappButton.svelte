...
{#if whatsappNumber}
  <a
    href="#whatsapp"
    class="bg-whatsapp shadow-border border-none text-white flex items-center
    justify-center group overflow-hidden text-sm md:hidden">
    <div
      class="grid place-items-center w-10 h-10 ml-1 mr-0.5 flex-shrink-0
      rounded-full">
      <svg
        viewBox="0 0 32 32"
        fill="currentColor"
