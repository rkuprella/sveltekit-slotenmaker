...
{#if whatsappNumber}
  <div
    class="md:hidden mx-3 mt-20 bg-gray-900 relative text-white"
    id="whatsapp">
    ...
    <div class="py-16 px-6 space-y-6">
      {#if !selectedService}
        ...
        <form action="" class="mt-6">
          ...
          <div class="flex justify-end space-x-3 mt-8">
            ...
            <a
              ...
              text-center flex items-center justify-center group overflow-hidden
              text-sm">
              <div
                class="bg-white/80 px-3 flex items-center space-x-3 py-3 h-full
