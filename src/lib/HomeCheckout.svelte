...
{#if whatsappNumber}
  <div class="md:hidden px-3 mt-8" id="whatsapp">
    <div
      class="shadow-border bg-whatsapp/10 border-whatsapp relative mx-auto
      max-w-lg">
      <div
      ...
      <div class="container mx-auto pt-12 pb-6 px-6 max-w-2xl space-y-6">
        {#if !selectedService}
          <p class="text-sm">
            Einfach Thema auswählen, über WhatsApp abschicken und blitzschnell
            eine Antwort inklusive Kostenübersicht erhalten.
          </p>
          <div class="space-y-3">
            <label for="service">Womit können wir Ihnen helfen?</label>
        ...
        {#if selectedService === 2}
          <form action="" class="mt-6">
            ...
            <div class="form-group">
              ...
              <label for="key">Schlüssel vorhanden?</label>
            </div>
            <div class="form-group">
              <input type="radio" id="radio" />
              <label for="radio">Unsichtbar</label>
            </div>
            <div class="">
              <label for="about" class="">Ihre Nachricht an uns</label>
              <div class="">
                <textarea id="about" name="about" rows="3" />
                <p class="">
                  Nach Ihrer Nachricht werden Sie sofort von unserem
                  Schlüsseldienstmonteur per WhatsApp kontaktiert.
                </p>
              </div>
            </div>
            <!-- whatsapp button -->
            <div class="flex justify-start mt-8">
              <a
                href={`https://api.whatsapp.com/send?phone=${formatPhoneNumber(whatsappNumber)}&amp;text=${formatWhatsappMessage(message)}`}
                class="bg-whatsapp shadow-border border-none text-white
                text-center flex items-center justify-center group pl-2
                space-x-1 overflow-hidden">
                <div
                  class="grid place-items-center w-10 h-10 flex-shrink-0
                  rounded-full">
                  <svg
                    viewBox="0 0 32 32"
                    fill="currentColor"
                    ...
                    <path
                      ...
                      0-.143-.73-2.09-.832-2.335-.143-.372-.214-.487-.6-.487-.187
                      0-.36-.043-.53-.043-.302 0-.53.115-.746.315-.688.645-1.032
                      1.318-1.06 2.264v.114c-.015.99.472 1.977 1.017 2.78 1.23
                      1.82 2.506 3.41 4.554 4.34.616.287 2.035.888 2.722.888.817
                      0 2.15-.515 2.478-1.318.13-.33.244-.73.244-1.088 0-.058
                      0-.144-.03-.215-.1-.172-2.434-1.39-2.678-1.39zm-2.908
                      7.593c-1.747 0-3.48-.53-4.942-1.49L7.793
                      24.41l1.132-3.337a8.955 8.955 0 0 1-1.72-5.272c0-4.955
                      4.04-8.995 8.997-8.995S25.2 10.845 25.2 15.8c0 4.958-4.04
                      8.998-8.998 8.998zm0-19.798c-5.96 0-10.8 4.842-10.8 10.8 0
                      1.964.53 3.898 1.546 5.574L5 27.176l5.974-1.92a10.807
                      10.807 0 0 0 16.03-9.455c0-5.958-4.842-10.8-10.802-10.8z"
                      fill-rule="evenodd" />
                  </svg>
                </div>
                <div
                  class="bg-black/40 px-3 flex items-center space-x-3 py-3
                  h-full">
